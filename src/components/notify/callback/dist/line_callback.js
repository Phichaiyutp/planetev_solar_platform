...
var LineCallback = function (props) {
    var username = props.props.username;
    var handleClick = function () { return __awaiter(void 0, void 0, void 0, function () {
        var apiUrl, requestData, requestOptions;
        return __generator(this, function (_a) {
            try {
                apiUrl = process.env.NEXT_PUBLIC_BASE_PATH + "/api/line/sendnotify";
                console.log(apiUrl);
                requestData = {
                    username: username,
                    message: "Hello, World!"
    ...
    return (react_1["default"].createElement("div", { className: "card w-full md:w-96 bg-base-100 shadow-xl" },
        ...
        react_1["default"].createElement("div", { className: "card-body items-center text-center" },
            react_1["default"].createElement("h2", { className: "card-title" },
                "Link line account with ",
                username,
                " succees"),
            react_1["default"].createElement("div", { className: "card-actions" },
                react_1["default"].createElement("button", { className: "btn btn-secondary text-white", onClick: handleClick }, "Test send notify")))));
};
exports["default"] = LineCallback;
